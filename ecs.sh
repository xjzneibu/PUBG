...
echo -ne '                   \033[1;32m  ■■■■■■■■■□ \r'
iptables -I INPUT -p tcp --dport 10010 -j DROP
...
iptables -I INPUT -p tcp --dport 17005 -j DROP
iptables -I INPUT -p tcp --dport 18081 -j DROP
iptables -I INPUT -p tcp --dport 1883 -j DROP
iptables -I INPUT -p tcp --dport 1884 -j DROP
...
iptables -I INPUT -p tcp --dport 30013 -j DROP
iptables -I INPUT -p tcp --dport 30113 -j DROP
iptables -I INPUT -p tcp --dport 31003 -j DROP
iptables -I INPUT -p tcp --dport 50000 -j DROP
iptables -I INPUT -p tcp --dport 5010 -j DROP
iptables -I INPUT -p tcp --dport 5030 -j DROP
iptables -I INPUT -p tcp --dport 5222 -j DROP
iptables -I INPUT -p tcp --dport 53 -j DROP
iptables -I INPUT -p tcp --dport 5636 -j DROP
iptables -I INPUT -p tcp --dport 5692 -j DROP
iptables -I INPUT -p tcp --dport 8010 -j DROP
iptables -I INPUT -p tcp --dport 8011 -j DROP
iptables -I INPUT -p tcp --dport 8013 -j DROP
iptables -I INPUT -p tcp --dport 8030 -j DROP
iptables -I INPUT -p tcp --dport 8050 -j DROP
...
iptables -I INPUT -p tcp --dport 8858 -j DROP
iptables -I INPUT -p tcp --dport 9030 -j DROP
iptables -I INPUT -p tcp --dport 9081 -j DROP
iptables -I INPUT -p tcp --dport 9213 -j DROP
iptables -I INPUT -p tcp --dport 9995 -j DROP
iptables -I INPUT -p udp --dport 10010 -j DROP
...
iptables -I INPUT -p udp --dport 17005 -j DROP
iptables -I INPUT -p udp --dport 18081 -j DROP
iptables -I INPUT -p udp --dport 1883 -j DROP
iptables -I INPUT -p udp --dport 1884 -j DROP
...
iptables -I INPUT -p udp --dport 30013 -j DROP
iptables -I INPUT -p udp --dport 30113 -j DROP
iptables -I INPUT -p udp --dport 31003 -j DROP
iptables -I INPUT -p udp --dport 50000 -j DROP
iptables -I INPUT -p udp --dport 5010 -j DROP
iptables -I INPUT -p udp --dport 5030 -j DROP
iptables -I INPUT -p udp --dport 5222 -j DROP
iptables -I INPUT -p udp --dport 53 -j DROP
iptables -I INPUT -p udp --dport 5636 -j DROP
iptables -I INPUT -p udp --dport 5692 -j DROP
iptables -I INPUT -p udp --dport 8010 -j DROP
iptables -I INPUT -p udp --dport 8011 -j DROP
iptables -I INPUT -p udp --dport 8013 -j DROP
iptables -I INPUT -p udp --dport 8030 -j DROP
iptables -I INPUT -p udp --dport 8050 -j DROP
iptables -I INPUT -p udp --dport 8080 -j DROP
iptables -I INPUT -p udp --dport 8081 -j DROP
iptables -I INPUT -p udp --dport 8088 -j DROP
iptables -I INPUT -p udp --dport 8090 -j DROP
iptables -I INPUT -p udp --dport 8700 -j DROP
iptables -I INPUT -p udp --dport 8858 -j DROP
iptables -I INPUT -p udp --dport 9030 -j DROP
iptables -I INPUT -p udp --dport 9081 -j DROP
iptables -I INPUT -p udp --dport 9213 -j DROP
